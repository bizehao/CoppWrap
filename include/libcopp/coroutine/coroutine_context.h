...
class coroutine_context : public coroutine_context_base {
 ...
 protected:
  ...
  std::function<void()> last_callback_;
 ...
 public:
  ...
  LIBCOPP_COPP_API int yield(std::function<void()> yield_callback, void **priv_data = nullptr) LIBCOPP_MACRO_NOEXCEPT;

  LIBCOPP_COPP_API void set_last_callback(std::function<void()> last_callback) {

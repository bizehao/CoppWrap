...
namespace cw {
    ...
    protected:
        ...
        std::function<void()> _lastCallback;
    ...
    class CoroutineContext<std::tuple<Args...>> :
        public CoroutineContextBase,
    ...
    public:
        CoroutineContext(std::function<void(Args...)> fun) : _fun{ fun } {}
    ...
    private:
        void startAndOp(ArgsTup tup) {
            ...
            if (_lastCallback) {
                _coObj->set_last_callback(_lastCallback);
            }
    ...
    public:
        CoroutineContextWrap(CoroutineContextPtr<std::tuple<Args...>> ptr) :coroPtr{ ptr } {
